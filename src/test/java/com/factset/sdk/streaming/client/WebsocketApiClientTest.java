...
public class WebsocketApiClientTest {
    ...
    public void subscribe_happy_path() throws Exception {
        AtomicInteger streamId = new AtomicInteger(0);
        ...
        assertEquals(
                Arrays.asList(
                        ExampleSubscriptionEvent.create(streamId.get(), 1),
                        ExampleSubscriptionEvent.create(streamId.get(), 2),
                        ExampleSubscriptionEvent.create(streamId.get(), 3)
                ),
                events
        );
    }
